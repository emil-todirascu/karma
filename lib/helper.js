...
const mm = typeof minimatchLib === 'function' ? minimatchLib : minimatchLib.minimatch
...
exports.browserFullNameToShort = (fullName) => {
  ...
  if (ua.os.name === 'Linux' && osVersion === '0.0.0' && ua.cpu && ua.cpu.architecture) {
...
exports.mkdirIfNotExists = (directory, done) => {
  ...
  const promiseMkdirp = mkdirp && typeof mkdirp.mkdirp === 'function' ? mkdirp.mkdirp : null
  if (promiseMkdirp) {
