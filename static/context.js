(() => {
  ...
  var require_reversed = __commonJS({
    "node_modules/ent/reversed.json"(exports, module) {
      module.exports = {
        "9": "Tab;",
        "10": "NewLine;",
        "33": "excl;",
  ...
  var require_encode = __commonJS({
    "node_modules/ent/encode.js"(exports, module) {
      ...
      function encode(str, opts) {
        ...
        if (opts.numeric !== void 0) numeric = opts.numeric;
  ...
  var require_dom_serialize = __commonJS({
    "node_modules/dom-serialize/index.js"(exports, module) {
  ...
  var require_stringify = __commonJS({
    "common/stringify.js"(exports, module) {
      var serialize = null;
      try {
  ...
  var require_karma = __commonJS({
    "context/karma.js"(exports, module) {
      var stringify = require_stringify();
      function ContextKarma2(callParentKarmaMethod2) {
        var hasError = false;
        var self = this;
        var isLoaded = false;
        this.log = function(type, args) {
          ...
          for (var i2 = 0; i2 < args.length; i2++) {
            values.push(this.stringify(args[i2], 3));
          }
        ...
        this.error = function() {
          hasError = true;
          callParentKarmaMethod2("error", [].slice.call(arguments));
          return false;
        };
        ...
        this.setupContext = function(contextWindow) {
          ...
          if (self.config.captureConsole) {
            ...
            for (var i2 = 0; i2 < logMethods.length; i2++) {
              patchConsoleMethod(logMethods[i2]);
            }
          }
        };
      }
  ...
  // context/main.js
  var ContextKarma = require_karma();
